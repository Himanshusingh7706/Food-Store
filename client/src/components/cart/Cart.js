...
const Cart = () => {
    ...
    const {cartItems} = useSelector((satisfies, state)=>satisfies.cart);
                ...
                <div className='row d-flex justify-content-between cartt'>
                                        ...
                                        <div className='row'>
                                            ...
                                            <div className='col-4 col-lg-3 mt-4 mt-lg-0'>
                                                <div className='stockCounter d-inline'>
                                                    ...
                                                    <input type='number' className='form-control count d-inline' value={item.quantity} readOnly></input>
                                                    {/* Increase qty btn */}
                    ...
                    <div className='col-12 col-lg-3 my-4'>
                        <div id='order_summary'>
                            ...
                            <p>
                                Subtotal:&nbsp;&nbsp;
                                <span className='oreder-summary-values'>
